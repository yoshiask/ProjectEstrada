...
{
	public class NumericalVector : IEquatable<NumericalVector>
	{
		double[] vector;
		...
		public NumericalVector(params double[] vals)
		{
			vector = vals;
		}
		...
		public NumericalVector(int dim)
		{
		...
		/// </summary>
		/// <returns></returns>
		public NumericalVector GetUnitVector()
		{
		...
		{
			NumericalVector axis = GetAxisVector(dir, Dimension);
		...
		/// <param name="a"></param>
		/// <param name="b"></param>
		public static void MakeSameDimension(NumericalVector a, NumericalVector b)
		{
		...
		/// <returns></returns>
		public static NumericalVector GetAxisVector(int dir, int dim)
		{
			NumericalVector axis = new NumericalVector(dim);
			for (int i = 0; i < dim; i++)
			{
				if (i == dir)
				{
		...
		public static NumericalVector operator -(NumericalVector a)
		{
			NumericalVector negative = new NumericalVector(a.Dimension);
		...
		public static NumericalVector operator +(NumericalVector a, NumericalVector b)
		{
			MakeSameDimension(a, b);
			NumericalVector add = new NumericalVector(a.Dimension);
			for(int i = 0; i < a.Dimension; i++)
			{
		...
		public static NumericalVector operator +(NumericalVector a, double b)
		{
			NumericalVector add = new NumericalVector(a.Dimension);
			for (int i = 0; i < a.Dimension; i++)
			{
		...
		{
			MakeSameDimension(a, b);
			NumericalVector subtract = new NumericalVector(a.Dimension);
			for (int i = 0; i < a.Dimension; i++)
			{
		...
		public static double operator *(NumericalVector a, NumericalVector b)
		{
			MakeSameDimension(a, b);
			double dot = 0;
			for(int i = 0; i < a.Dimension; i++)
		...
		public static NumericalVector operator *(NumericalVector a, double b)
		{
			NumericalVector scaled = new NumericalVector(a.Dimension);
			for(int i = 0; i < a.Dimension; i++)
			{
		...
		/// </summary>
		/// <param name="b"></param>
		public NumericalVector Add(NumericalVector b)
		{
			MakeSameDimension(this, b);
			NumericalVector add = new NumericalVector(Dimension);
		...
		/// </summary>
		/// <param name="b"></param>
		public NumericalVector Subtract(NumericalVector b)
		{
			MakeSameDimension(this, b);
			NumericalVector subtract = new NumericalVector(Dimension);
			for (int i = 0; i < Dimension; i++)
			{
		...
		/// </summary>
		/// <param name="b"></param>
		public double Dot(NumericalVector b, bool throwIfNotSameDimension)
		{
		...
		/// </summary>
		/// <param name="b"></param>
		public NumericalVector Cross(NumericalVector b, bool throwIfNotTwoOrThreeDim = false)
		{
			...
			SetDimension(3);
			b.SetDimension(3);
			NumericalVector cross = new NumericalVector(3);
		...
		/// </summary>
		/// <param name="b"></param>
		public NumericalVector Scalar(double b)
		{
			NumericalVector scalar = new NumericalVector(Dimension);
			for (int i = 0; i < Dimension; i++)
			{
		...
		public bool Equals(NumericalVector b)
		{
