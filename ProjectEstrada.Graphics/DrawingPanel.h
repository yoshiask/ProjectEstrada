...
namespace ProjectEstrada_Graphics
{
    ...
    [Windows::Foundation::Metadata::WebHostHidden]
    public delegate void RecognitionResultUpdatedEventHandler(Platform::Object^ sender, ProjectEstrada_Graphics::RecognitionResultUpdatedEventArgs^ s);
    ...
    [Windows::Foundation::Metadata::WebHostHidden]
    public ref class DrawingPanel sealed : public ProjectEstrada_Graphics::DirectXPanelBase
    {
    public:
        DrawingPanel();
