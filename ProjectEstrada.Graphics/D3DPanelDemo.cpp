...
using namespace ProjectEstrada_Graphics;
using namespace DX;

D3DPanelDemo::D3DPanelDemo() :
...
void D3DPanelDemo::StartRenderLoop()
{
...
void D3DPanelDemo::CreateDeviceResources()
{
    ...
    auto loadVSTask = DX::ReadDataAsync(L"ProjectEstrada_Graphics\\SimpleVertexShader.cso");
    ...
    auto loadPSTask = DX::ReadDataAsync(L"ProjectEstrada_Graphics\\SimplePixelShader.cso");
...
void D3DPanelDemo::CreateSizeDependentResources()
{
